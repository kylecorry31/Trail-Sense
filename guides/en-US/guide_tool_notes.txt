...
1. Tap the '+' button in the bottom-right corner to create a note, or tap an existing one in the list.
2. You can edit the title and/or content of the note.
3. Tap the checkmark button in the bottom-right corner to save.
