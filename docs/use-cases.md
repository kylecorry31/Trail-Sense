...
- Provide features to assist in the following activities: hiking, backpacking, camping, geocaching, wilderness survival, foraging, fishing, and hunting.
...
- I want to know where the bullet will hit at different distances
- I want to know if my shot has enough energy for ethically using on a particular species
...
## Beacons
- I want to record where I am so I can navigate back to this location
- I want to mark a location in the distance so I can navigate there
- I want to mark POIs before my hike so I can navigate and know what is around me
...
## Climate
- I want to know the best time a year to book an outdoors trip
- I want to understand what the weather is normally like in this area
- I want to know if I should put on bug spray
...
## Declination
- I want to check that the declination listed on an old map is still usable
- I want to adjust my physical compass' declination

## Diagnostics
- I want to troubleshoot an issue I'm having with Trail Sense

## Field Guide
Species is interchangeable with other natural objects (ex. rocks) in the below use cases.

- I want to know about common species in my area which are useful for wilderness survival
- I want to record the location of a species so I can come back for foraging or hunting
- I want to record notes about a species to improve my chance of encounters
...
## Magnifier
- I want to magnify small text on a map/sign

## Map
- I want to see where I am on a map
- I want to navigate using a map
- I want to see what is around me
- I want to see how steep a path will be
...
- I want to know how fast I'm hiking
- I want to know where I am
- I want to know where I'm facing
- I want to share where I am
...
- I want to use a map file I downloaded and see my location, beacons, and paths on it
- I want to use a map file I downloaded and measure the distance between two points on it
- I want to use a map file I downloaded and place a beacon at a point on the map
...
- I want to stop after a certain distance

## QR Code Scanner
- I want to share a location offline
- I want to share a note offline
- I want to read a QR code containing text found on a trail sign or geocache
- I want to read a QR code containing a link found on a trail sign or geocache
...
- I want to measure a small object

## Sensors
- I want to verify the sensors are working correctly on my phone

## Signal Finder
- I want to know where I can go to get a better cell signal
...
## Survival Guide
- I want to deal with unplanned survival situations

## Temperature Estimation
- I want to know if it will be cold at my destination
- I want to know what the temperature will actually feel like given the weather conditions

## Tides
- I want to know when the next high or low tide will be
- I want to know what the height of the tide is
- I want to know when the tide is rising or falling

## Triangulate Location
- I want to know my location even if I can't get a GPS signal
- I want to know the location of a place I see in the distance

## Turn Back
- I want to return to a location at a specific time
- I want to return to a location before it gets dark

## User Guide
- I want to learn how to use Trail Sense
