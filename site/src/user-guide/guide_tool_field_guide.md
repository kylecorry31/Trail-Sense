...
## Create a page
To create a new page, tap the add button in the bottom right corner of the screen. You can add a name, image, notes, and tags to the page. The image can be taken with the camera or selected from the gallery. You can tap the check button in the top right corner to save the page.
...
## Edit a page
To edit a page, tap the menu button on a page row and select 'Edit'. You can change the name, image, notes, and tags of the page. You can tap the check button in the top right corner to save the changes.
...
You can create a new sighting by tapping the plus button in the bottom right of the sightings list. You can fill out the time, location, elevation, whether it was harvested, whether to show on map, and notes. All fields are optional. Tap the check button in the top right to save the sighting.
...
You can hide individual sightings from appearing on the Sightings map layer. When creating or editing a sighting, toggle the 'Show on map' switch off to hide the sighting from the map. By default, sightings are shown on the map.

## Delete a page
To delete a page, tap the menu button on a page row and select 'Delete'. You will be asked to confirm the deletion. Deleting a page is permanent and cannot be undone.
