...
To use the quick action, tap the quick action button to open a search box. The most relevant section's content will be displayed. Clicking on the section will open the chapter with the section expanded. Clicking the guide icon in the top right of the sheet will open the Survival Guide tool with your search query.
