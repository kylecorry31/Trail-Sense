...
Una aplicación guía de supervivencia. Esta app te enseñará cómo usar los recursos a tu alrededor para sobrevivir en casi cualquier entorno.
...
Esta app es una red social para naturalistas. Puedes usarla para registrar tus observaciones de plantas y animales, compartirlas con otras personas y comentar tus hallazgos. También es útil para obtener la identificación de especies, ya sea por otra persona o mediante reconocimiento de imágenes.
...
Esta app puede ayudarte a identificar hongos haciéndote responder un cuestionario sobre las características del hongo o mostrando imágenes de hongos comunes en tu zona. Asegúrate de seleccionar la región correcta.
...
Esta app proporciona un metrónomo y puede usarse para música en el campamento o meditación.

[Download](market://details?id=xyz.zedler.patrick.tack)

## Briar

Esta app permite comunicación cifrada offline usando bluetooth o WiFi direct.
