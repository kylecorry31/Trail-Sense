...
class FormatService private constructor(private val context: Context) {
    ...
    fun formatWeight(weight: Weight, decimalPlaces: Int = 0, strict: Boolean = true): String {
        ...
        return when (weight.units) {
            ...
            WeightUnits.Stone -> strings.getString(R.string.stone_format, formatted)
        }
    }
    ...
    fun formatOfflineMapFileTypeName(type: OfflineMapFileType): String {
        return when (type) {
            OfflineMapFileType.Mapsforge -> strings.getString(R.string.mapsforge)
        }
    }
    ...
    fun getWeightUnitName(unit: WeightUnits, short: Boolean = false): String {
        if (short) {
            return when (unit) {
                ...
                WeightUnits.Stone -> strings.getString(R.string.stone_format, "")
            }.replace(" ", "")
        }
        return when (unit) {
            ...
            WeightUnits.Stone -> strings.getString(R.string.stone)
        }
    }
