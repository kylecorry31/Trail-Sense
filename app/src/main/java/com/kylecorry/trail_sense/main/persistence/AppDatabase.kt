    ...
    companion object {
        ...
        private fun buildDatabase(context: Context): AppDatabase {
            ...
            val MIGRATION_45_46 = object : Migration(45, 46) {
                override fun migrate(db: SupportSQLiteDatabase) {
                    db.execSQL("ALTER TABLE `field_guide_sightings` ADD COLUMN `show_on_map` INTEGER NOT NULL DEFAULT 1")
                }
            }
            ...
            val MIGRATION_47_48 = object : Migration(47, 48) {
                override fun migrate(db: SupportSQLiteDatabase) {
                    db.execSQL("ALTER TABLE `items` ADD COLUMN `isOptional` INTEGER NOT NULL DEFAULT 0")
                }
            }
            ...
            val MIGRATION_50_51 = object : Migration(50, 51) {
                override fun migrate(db: SupportSQLiteDatabase) {
                    db.execSQL("CREATE TABLE IF NOT EXISTS `plugin_registrations` (`package_id` TEXT NOT NULL, `version_code` INTEGER NOT NULL, `payload` BLOB NOT NULL, PRIMARY KEY(`package_id`))")
                }
            }
            ...
            val MIGRATION_52_53 = object : Migration(52, 53) {
                override fun migrate(db: SupportSQLiteDatabase) {
                    db.execSQL("ALTER TABLE `offline_map_files` ADD COLUMN `parent` INTEGER DEFAULT NULL")
                    db.execSQL("CREATE INDEX IF NOT EXISTS `index_offline_map_files_parent` ON `offline_map_files` (`parent`)")
                    db.execSQL(
                        """
                        CREATE TABLE IF NOT EXISTS `offline_map_file_groups` (
                            `_id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
                            `name` TEXT NOT NULL,
                    ...
                    db.execSQL("CREATE INDEX IF NOT EXISTS `index_offline_map_file_groups_parent` ON `offline_map_file_groups` (`parent`)")
                }
            }

            val MIGRATION_53_54 = object : Migration(53, 54) {
                override fun migrate(db: SupportSQLiteDatabase) {
                    db.execSQL("ALTER TABLE `offline_map_files` ADD COLUMN `attribution` TEXT DEFAULT NULL")
                }
            }
            ...
            val MIGRATION_55_56 = object : Migration(55, 56) {
                override fun migrate(db: SupportSQLiteDatabase) {
                    db.execSQL("ALTER TABLE `maps` ADD COLUMN `created_on` INTEGER DEFAULT NULL")
                }
            }
            ...
            val MIGRATION_59_60 = object : Migration(59, 60) {
                override fun migrate(db: SupportSQLiteDatabase) {
                    db.execSQL("ALTER TABLE `field_guide_pages` ADD COLUMN `scientific_name` TEXT DEFAULT NULL")
                }
            }
