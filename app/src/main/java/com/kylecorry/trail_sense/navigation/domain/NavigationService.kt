...
class NavigationService {
    ...
    fun navigate(from: Coordinate, to: Beacon): NavigationVector {
        return getNavigationVector(from, to.coordinate)
    }

    fun navigate(from: Coordinate, path: Path): NavigationVector {
        return getNavigationVector(from, getNextDestination(from, path))
    }
