...
import com.kylecorry.trail_sense.shared.domain.IMappableReferencePoint
...
import com.kylecorry.trail_sense.tools.navigation.ui.compass.radar.CompassDial
import com.kylecorry.trail_sense.tools.navigation.ui.compass.BaseCompassView
import kotlin.math.min

class RadarCompassView : BaseCompassView {
    private var centerPixel: PixelCoordinate =
        com.kylecorry.andromeda.core.units.PixelCoordinate(0f, 0f)
    ...
    private val formatService by lazy { FormatService.Companion.getInstance(context) }
    ...
    private var maxDistanceBaseUnits: Distance = Distance.Companion.meters(0f)
    private var maxDistanceMeters: Distance = Distance.Companion.meters(0f)
    private var north = ""
    private var south = ""
    private var east = ""
    private var west = ""
    ...
    override fun setup() {
        ...
        centerPixel = com.kylecorry.andromeda.core.units.PixelCoordinate(width / 2f, height / 2f)
    ...
    override fun draw(bearing: IMappableBearing, stopAt: Coordinate?) {
        ...
        arc(
            ...
            compassSize.toFloat(),
            azimuth - 90,
            azimuth - 90 + Trigonometry.deltaAngle(azimuth, bearing.bearing),
            ArcMode.Pie
        )
