...
object TurnBackToolRegistration : ToolRegistration {
    override fun getTool(context: Context): Tool {
        return Tool(
            ...
            notificationChannelGroups = listOf(
                ToolNotificationChannelGroup(NOTIFICATION_CHANNEL_GROUP_TURN_BACK, context.getString(R.string.tool_turn_back))
            ),
            notificationChannels = listOf(
                ToolNotificationChannel(
                    ...
                    false,
                    groupId = NOTIFICATION_CHANNEL_GROUP_TURN_BACK
                ),
                ToolNotificationChannel(
    ...
    const val NOTIFICATION_CHANNEL_GROUP_TURN_BACK = "turn-back"
}
