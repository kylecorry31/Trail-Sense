...
import com.kylecorry.trailsensecore.infrastructure.audio.SoundGenerator
import com.kylecorry.trailsensecore.infrastructure.audio.SoundPlayer
import kotlin.math.abs
import kotlin.random.Random

class MyPinkNoise : SoundPlayer(MyPinkNoiseGenerator().getNoise(durationSeconds = 5))

class MyPinkNoiseGenerator {
